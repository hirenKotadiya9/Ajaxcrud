...
<body id="page-top">
    ...
    <script src="utilities-animation/vendor/jquery/jquery.min.js"></script>
    <script src="utilities-animation/vendor/bootstrap/js/bootstrap.bundle.min.js"></script>

    <!-- Core plugin JavaScript-->
    <script src="utilities-animation/vendor/jquery-easing/jquery.easing.min.js"></script>

    <!-- Custom scripts for all pages-->
    <script src="utilities-animation/js/sb-admin-2.min.js"></script>
